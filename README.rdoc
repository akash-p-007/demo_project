...
About:
It is a simple ruby on rails project consisting for following: User registration to access the application.This can be done using facebook,google+ or by signinig up manually.
