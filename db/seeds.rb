...
u4 = User.create({name: "Superadmin", email: "superadmin@example.com", password: "123456", password_confirmation: "123456", role_id: r3.id, approved: 't',confirmed_at: Time.now.utc})
u5 = User.create({name: "Admin",email: "admin@example.com", password: "123456", password_confirmation: "123456", role_id: r2.id, approved: "t",confirmed_at: Time.now.utc})
